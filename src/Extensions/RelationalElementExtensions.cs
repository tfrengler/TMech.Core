...
namespace TMech.Core.Extensions
{
    public static class RelationalElementExtensions
    {
        ...
        /// </summary>
        public static IElement FetchNextSibling(this Element self, string tagName = "*")
        {
            var Locator = By.XPath($"(./following-sibling::{tagName})[1]");
            return self.Within().Fetch(Locator);
        }
        ...
        /// </summary>
        public static IElement FetchParent(this Element self)
        {
        ...
        /// </summary>
        public static IElement FetchPreviousSibling(this Element self, string tagName = "*")
        {
        ...
        /// </summary>
        public static IElement FetchAncestor(this Element self, string tagName = "*")
        {
        ...
        /// </summary>
        public static IElement[] FetchDescendants(this Element self, string tagName = "*", uint threshold = 1)
        {
        ...
        /// </summary>
        public static IElement[] FetchChildren(this Element self, string tagName = "*", uint threshold = 1)
        {
            return InternalGetChildrenOrDescendants(self, tagName, true, threshold);
        }

        private static IElement[] InternalGetChildrenOrDescendants(Element self, string tagName, bool children, uint threshold)
        {
            string Axis = children ? "child" : "descendant";
            var Locator = By.XPath($"./{Axis}::{tagName}");

            IElement[] ReturnData = self.Within().FetchAll(Locator, threshold);
            return ReturnData;
        }
    }
}
